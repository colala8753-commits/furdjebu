...
do
	...
	ExtraMiscScroll.CanvasSize = UDim2.new(0, 0, 0, 200)

	createConfigToggle(ExtraMiscScroll, 10, "CollectGoldenKey", "golden", function() return collectGoldenEnabled end, function(v) collectGoldenEnabled = v end, setCollectGolden)
	createConfigToggle(ExtraMiscScroll, 78, "CollectSecretKey", "secret", function() return collectSecretEnabled end, function(v) collectSecretEnabled = v end, setCollectSecret)
