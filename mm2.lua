-- furdjehub - Murder Mystery 2 (Ultimate Edition)
-- Полностью новый скрипт с максимальной стабильностью
...
-- Функции для создания GUI элементов
local yPos = 5
...
print("⚡ furdjehub Ultimate Edition loaded! (650x450)")
